...
import MonthlySummaryPanel from './components/MonthlySummaryPanel.vue'
  ...
  <div>
    ...
    <section class="content-grid">
      <EmployeeDirectoryPanel
        ...
        :hidden-inactive-count="hiddenInactiveCount"
        :employee-form="employeeForm"
        :editing-employee-id="editingEmployeeId"
        :submitting="submitting"
        :format-minutes="formatMinutes"
        :on-save-employee="saveEmployee"
        :on-reset-employee-form="resetEmployeeForm"
        :on-toggle-employee="toggleEmployee"
        :on-start-edit-employee="startEditEmployee"
      />

      <MonthlySummaryPanel
        :month-summary="monthSummary"
        :month-title="formatMonthTitle(monthSummary)"
        :selected-employee-id="selectedEmployeeId"
        :selected-employee-summary="selectedEmployeeSummary"
        :selected-work-date="selectedWorkDate"
        :downloading-report="downloadingReport"
        :format-date="formatDate"
        :format-minutes="formatMinutes"
        :format-currency="formatCurrency"
        :on-select-employee="(employeeId: number) => { selectedEmployeeId = employeeId }"
        :on-edit-day="editDay"
        :on-download-report="downloadEmployeeReport"
      >
